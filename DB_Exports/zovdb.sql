...
--
-- Хост: localhost
-- Время создания: Дек 08 2020 г., 11:18
...
CREATE TABLE `goods` (
  ...
  `descriptionen` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `descriptionch` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `descriptionkz` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `descriptionkg` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `descriptiontr` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `descriptiontc` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `avgstarscount` double NOT NULL,
  `commentcount` int(11) NOT NULL,
  `ordercount` int(11) NOT NULL,
  `price` double NOT NULL,
  `pricemany` double NOT NULL,
  `additionaldiscountpercent` double NOT NULL,
  `additionaldiscountpercentcount` int(11) NOT NULL,
...
(2, 1, 1, 2, 0, '', 'Мужские роскошные часы', '', '', '', '', '', '', '', 'Чвсы уцпуцпц упцупцуацу пкцупцуп пц цупцуп цуп', '', '', '', '', '', '', 5, 21, 14, 45.33, 42, 6, 30, 15, '', NULL, NULL),
(3, 1, 1, 4, -1, '', 'Лейка для душа2', '', '', '', '', '', '', '', 'Лейка для душа с эффектом дождя, насадка для душа, 300 отверстий, водосберегающий фильтр, распылительная насадка с функцией экономии воды под высоким давлением ', '', '', '', '', '', '', 3.7, 358, 24, 12, 10, 20, 100, 15, '', NULL, NULL),
(4, 1, 1, 2, 0, '', 'Мужские роскошные часы2', '', '', '', '', '', '', '', 'Чвсы уцпуцпц упцупцуацу пкцупцуп пц цупцуп цуп', '', '', '', '', '', '', 5, 21, 14, 45.33, 42, 6, 30, 15, '', NULL, NULL),
(5, 1, 1, 4, -1, '', 'Лейка для душа3', '', '', '', '', '', '', '', 'Лейка для душа с эффектом дождя, насадка для душа, 300 отверстий, водосберегающий фильтр, распылительная насадка с функцией экономии воды под высоким давлением ', '', '', '', '', '', '', 3.7, 358, 24, 12, 10, 20, 100, 15, '', NULL, NULL),
(6, 1, 1, 2, 0, '', 'Мужские роскошные часы3', '', '', '', '', '', '', '', 'Чвсы уцпуцпц упцупцуацу пкцупцуп пц цупцуп цуп', '', '', '', '', '', '', 5, 21, 14, 45.33, 42, 6, 30, 15, '', NULL, NULL),
(7, 1, 1, 4, -1, '', 'Лейка для душа4', '', '', '', '', '', '', '', 'Лейка для душа с эффектом дождя, насадка для душа, 300 отверстий, водосберегающий фильтр, распылительная насадка с функцией экономии воды под высоким давлением ', '', '', '', '', '', '', 3.7, 358, 24, 12, 10, 20, 100, 15, '', NULL, NULL),
(8, 1, 1, 2, 0, '', 'Мужские роскошные часы4', '', '', '', '', '', '', '', 'Чвсы уцпуцпц упцупцуацу пкцупцуп пц цупцуп цуп', '', '', '', '', '', '', 5, 21, 14, 45.33, 42, 6, 30, 15, '', NULL, NULL);
...
CREATE TABLE `good_pics` (
  ...
  `fileNamesmall` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `good_shops` (`id`, `title`, `titleru`, `titleen`, `titlech`, `titlekz`, `titlekg`, `titletr`, `titletc`, `ownerid`, `shoplogotip`, `instagramlink`, `facebooklink`, `web`, `phone`, `phone2`, `email`, `created_at`, `updated_at`) VALUES
(1, '', 'shoppo', '', '', '', '', '', '', 1, '', '', '', 'shoppo.ru', '+994505351980', '', 'shoppo@gmail.com', NULL, NULL);
...
(15, 'Etimad', 'Bat', 'ffqwfq', NULL, 0, NULL, '+994505351933', 'AZE000000', NULL, NULL, NULL, 'etimadh@bayramov.com', '$2y$10$n9PQfIzpE2s..l3YO.BW1OZxd70nllIr7V2rSx1IuQlSCQ8yO6dMW', 0, NULL, '2020-02-21 23:07:22', '2020-02-21 23:07:22'),
...
--
-- Индексы таблицы `searchrequestpictures`
--
ALTER TABLE `searchrequestpictures`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `searchrequests`
--
ALTER TABLE `searchrequests`
  ADD PRIMARY KEY (`id`);
...
--
-- Индексы таблицы `zovadresses`
--
ALTER TABLE `zovadresses`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT для таблицы `bonuscards`
--
ALTER TABLE `bonuscards`
...
--
-- AUTO_INCREMENT для таблицы `good_cats`
--
ALTER TABLE `good_cats`
...
--
-- AUTO_INCREMENT для таблицы `good_genders`
--
ALTER TABLE `good_genders`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT для таблицы `good_orders`
--
ALTER TABLE `good_orders`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT для таблицы `kuryers`
--
ALTER TABLE `kuryers`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT для таблицы `searchrequestpictures`
--
ALTER TABLE `searchrequestpictures`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `searchrequests`
--
ALTER TABLE `searchrequests`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT для таблицы `zovadresses`
--
ALTER TABLE `zovadresses`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
COMMIT;
