...
<div class="register-photo" style="background-color: rgb(255,255,255);padding: 20px 0px;">
    ...
    <div class="form-container">
        ...
        <form method="post">
            ...
            <h2 class="text-center" style="font-size: 14px;">Напишите нам</h2><input class="form-control" type="password" name="name" placeholder="Имя">
            <div class="form-group"><input class="form-control" type="email" name="email" placeholder="Email" style="margin: 15px 0px;"></div>
            <div class="form-group"><input class="form-control" type="password" name="phone" placeholder="Телефон"></div>
            <div class="form-group"><textarea class="form-control" rows="20" cols="1" placeholder="Текст"></textarea></div>
